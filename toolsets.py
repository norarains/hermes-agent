...
TOOLSETS = {
    ...
    "hermes-onebot-napcat": {
        "description": "QQ (NapCat/OneBot v11) toolset - real QQ account with group support",
        "tools": _HERMES_CORE_TOOLS,
        "includes": []
    },
